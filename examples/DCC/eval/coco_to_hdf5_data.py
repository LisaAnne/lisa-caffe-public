...
sys.path.append('../captions_add_new_word')
...
def process_coco(tag='', include_val = True, include_trainval=False, vocab_file=None):
  ...
  datasets = [(tag+'train', 'train', 100000, True)]
  #datasets = [
...
if __name__ == "__main__":
  #process_coco()
  if eightyK:
    process_coco('rm_secondCluster', False, False, '/yy2/lisaanne/pretrained_lm/yt_coco_surface_80k_vocab.txt')
  else:
    process_coco('rm_eightCluster_2', False, False, 'h5_data/buffer_100/vocabulary.txt')
