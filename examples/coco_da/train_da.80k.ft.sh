...
GPU_ID=1
WEIGHTS=\
/x/lisaanne/coco_caption/snapshots/coco_da_train_direct_attributes_ftPredictLM_pretrainAttributes_zebraClassifier_80k_iter_100000.caffemodel
...
#/x/lisaanne/pretrained_lm/mrnn.lm.direct_surf_lr0.01_iter_120000.caffemodel,attributes_JJ100_NN300_VB100_zebra_iter_50000.caffemodel
