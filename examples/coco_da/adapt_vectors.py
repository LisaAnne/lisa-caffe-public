...
w = 'sheep.giraffeLM_giraffeIM'
save_tag = 'experiment_da_dlm_%s' %w
...
model_weights_lm = '/x/lisaanne/coco_caption/final_snapshots/mrnn.direct_iter_110000'
...
transfer_words_lm = [['giraffe', 'sheep'], ['giraffe', 'sheep']]
