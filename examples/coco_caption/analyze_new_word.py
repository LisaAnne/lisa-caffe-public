...
if beam1:
  if not os.path.exists(beam1_json_path) or always_recompute:
    ...
    retrieval_experiment.main(model_name=trained_model, image_net=image_model, LM_net=language_model, dataset_name='val_val', vocab='vocabulary', feats_bool_in=False, experiment=experiment)
