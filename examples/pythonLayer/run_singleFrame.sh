...
GLOG_logtostderr=1  $TOOLS/caffe train -solver singleFrame_solver.prototxt -weights /home/lisaanne/caffe-forward-backward/examples/pose_Georgia/JHMDB_actions/ucf101_RGB_single_frame_model.caffemodel > testing_readImagePython_debugInfo.out 2>&1
