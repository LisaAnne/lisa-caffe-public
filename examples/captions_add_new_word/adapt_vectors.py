...
num_close_words_im_list = [1, 1, 1]
num_close_words_lm_list = [1, 3, 5]

rm_word_base = 'eightCluster1'
...
for num_close_words_im, num_close_words_lm in zip(num_close_words_im_list, num_close_words_lm_list):
  ...
  if not eightyk: 
    ...
    model = 'mrnn_attributes_fc8.direct.from_features.wtd.80k.ft.prototxt' #the wtd has all the parameters we care about and will take up less memory
  ...
  #coco images, cocoLM
  #model_weights_trained = '/y/lisaanne/mrnn_direct/snapshots/attributes_JJ100_NN300_VB100_eightClusters_captions_cocoImages_1026_ftLM_pretrain50k_1031_iter_10000' 
  #imagenet images, cocoLM
  ...
  #imagenet iamges, surfLM
  model_weights_trained = '/y/lisaanne/mrnn_direct/snapshots/attributes_JJ100_NN300_VB100_eightClusters_captions_imagenetImages_1026_ftLM_pretrain110k_direct_surf_lr0.01_iter_120000.1101_iter_110000'
  ...
  if not eightyk:
    ...
    vocab = open('/y/lisaanne/pretrained_lm/yt_coco_surface_80k_vocab.txt').readlines()
